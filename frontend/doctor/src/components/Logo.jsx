      ...
      <div className="w-[180px] h-[60px]">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-91.595 -7.938 213.88 57.557">
          ...
          <text
            x="-30.259"
            y="42.035"
            className="fill-[#333333] font-sans text-sm font-bold whitespace-pre"
          >
            Dashboard Panel
          </text>
        </svg>
